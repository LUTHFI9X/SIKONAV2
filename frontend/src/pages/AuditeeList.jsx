          ...
          <div className="max-w-xl">
            <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1.5">
              <div className="w-6 h-6 bg-white/10 rounded-lg flex items-center justify-center">
                <IconUserGroup className="w-3.5 h-3.5 text-indigo-200" />
              </div>
              <span className="text-indigo-100 text-[10px] font-semibold uppercase tracking-wider">Daftar Auditee</span>
            </div>
            <h1 className="text-xl md:text-2xl font-extrabold tracking-tight leading-tight">{userBiro || 'Biro Auditor'}</h1>
            <p className="text-indigo-100/80 text-[11px] md:text-xs mt-1.5 max-w-lg">Auditee yang mengirim konsultasi ke biro Anda</p>
          </div>

          <div className="grid grid-cols-2 gap-2 md:gap-2.5">
            {[
              { label: 'Auditee', value: stats.total, color: 'text-white' },
              { label: 'Konsultasi', value: stats.totalKonsultasi, color: 'text-cyan-200' },
            ].map((s, i) => (
